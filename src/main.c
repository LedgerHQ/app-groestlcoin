...
#define UI_NANOS_BACKGROUND()                                                  \
  {                                                                            \
    {BAGL_RECTANGLE, 0, 0, 0, 128, 32, 0, 0, BAGL_FILL, 0, COLOR_WHITE, 0, 0}, \
...
#define UI_NANOS_ICON_RIGHT(userid, glyph)                                     \
  {                                                                            \
    {BAGL_ICON, userid, 117, 13, 8, 6, 0, 0, 0, COLOR_WHITE, 0, 0, glyph},     \
        NULL, 0, 0, 0, NULL, NULL, NULL                                        \
  }
...
#define UI_BLUE_BACKGROUND(title)                                              \
  ...
  {                                                                            \
    {BAGL_LABELINE,                                                            \
     ...
     0},                                                                       \
        title, 0, 0, 0, NULL, NULL, NULL                                       \
  }
#define UI_BLUE_BUTTON_SETTINGS(setting_cb)                                    \
  {                                                                            \
    {BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,                                     \
     0x00,                                                                     \
     0,                                                                        \
     19,                                                                       \
     56,                                                                       \
     ...
     0},                                                                       \
        BAGL_FONT_SYMBOLS_0_SETTINGS, 0, COLOR_APP, COLOR_WHITE, setting_cb,   \
        NULL, NULL                                                             \
  }
#define UI_BLUE_BUTTON_GO_BACK(back_cb)                                        \
  {                                                                            \
    {BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,                                     \
     0x00,                                                                     \
     0,                                                                        \
     ...
     BAGL_FONT_SYMBOLS_0 | BAGL_FONT_ALIGNMENT_CENTER |                        \
         BAGL_FONT_ALIGNMENT_MIDDLE,                                           \
     0},                                                                       \
        BAGL_FONT_SYMBOLS_0_LEFT, 0, COLOR_APP, COLOR_WHITE, back_cb, NULL,    \
        NULL                                                                   \
  }
#define UI_BLUE_ICON(userid, x, y, width, height, icon, bg_color)              \
  {                                                                            \
    {BAGL_ICON, userid,    x, y,        width, height, 0,                      \
     0,         BAGL_FILL, 0, bg_color, 0,     0},                             \
        icon, 0, 0, 0, NULL, NULL, NULL                                        \
  }
// Toggle icon should be set/updated within a preprocessor
#define UI_BLUE_TOGGLE(x, y, bg_color)                                         \
  {                                                                            \
    {BAGL_ICON, 0x01,      x,           y,        320, 18, 0,                  \
     0,         BAGL_FILL, COLOR_BLACK, bg_color, 0,   0},                     \
        NULL, 0, 0, 0, NULL, NULL, NULL                                        \
  }
#define UI_BLUE_TOUCHZONE(x, y, x_max, y_max, tap_cb, out_cb, over_cb)         \
  {                                                                            \
    {BAGL_NONE | BAGL_FLAG_TOUCHABLE,                                          \
     0x00,                                                                     \
     x,                                                                        \
     y,                                                                        \
     x_max,                                                                    \
     ...
     0,                                                                        \
     0},                                                                       \
        NULL, 0, COLOR_LIGHT_GRAY, COLOR_BLACK, tap_cb, out_cb, over_cb        \
  }
#define UI_BLUE_BUTTON_EXIT(exit_cb)                                           \
  {                                                                            \
    {BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,                                     \
     0x00,                                                                     \
     264,                                                                      \
     ...
     BAGL_FONT_SYMBOLS_0 | BAGL_FONT_ALIGNMENT_CENTER |                        \
         BAGL_FONT_ALIGNMENT_MIDDLE,                                           \
     0},                                                                       \
        BAGL_FONT_SYMBOLS_0_DASHBOARD, 0, COLOR_APP, COLOR_WHITE, exit_cb,     \
        NULL, NULL                                                             \
  }
// Displays standard interface for approval: 2 buttons at the bottom of the
// screen, one to cancel and one to proceed
#define UI_BLUE_BUTTONS_REJECT_OR_CONFIRM(reject_text, confirm_text,           \
                                          reject_cb, confirm_cb)               \
  ...
  {                                                                            \
    {BAGL_RECTANGLE | BAGL_FLAG_TOUCHABLE,                                     \
     ...
     BAGL_FONT_OPEN_SANS_REGULAR_11_14PX | BAGL_FONT_ALIGNMENT_CENTER |        \
         BAGL_FONT_ALIGNMENT_MIDDLE,                                           \
     0},                                                                       \
        confirm_text, 0, 0x3ab7a2, COLOR_BG_1, confirm_cb, NULL, NULL          \
  }
#define UI_BLUE_TEXT(userid, x, y, w, text, font, flags, text_color, bg_color) \
  {                                                                            \
    {BAGL_LABELINE, userid,       x, y, w, 30, 0, 0, BAGL_FILL, text_color,    \
     bg_color,      font | flags, 0},                                          \
        (char *)text, 0, 0, 0, NULL, NULL, NULL                                \
  }
...
union {
  ...
  struct {
    // A bip44 path contains 5 elements, which max length in ascii is 10 char +
    // optional quote "'" + "/" + \0"
...
void load_qr_code(unsigned char *data) {
  ...
  if (qrcodegen_encodeBinary(
          data, strlen(data), G_io_seproxyhal_spi_buffer,
...
const bagl_element_t ui_idle_blue[] = {
    ...
    UI_BLUE_TEXT(0, 0, 270, 320, "Open your wallet",
                 BAGL_FONT_OPEN_SANS_LIGHT_16_22PX, BAGL_FONT_ALIGNMENT_CENTER,
                 COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 308, 320, "Connect your Ledger Blue and open your",
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 331, 320, "preferred wallet to view your accounts.",
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 450, 320, "Validation requests will show automatically.",
                 BAGL_FONT_OPEN_SANS_REGULAR_8_11PX, BAGL_FONT_ALIGNMENT_CENTER,
                 COLOR_GRAY, COLOR_BG_1)
...
ui_settings_blue_toggle_pubKeyRequestRestriction(const bagl_element_t *e) {
  // swap setting and request redraw of settings elements
  uint8_t setting = N_btchip.pubKeyRequestRestriction ? 0 : 1;
  nvm_write(&N_btchip.pubKeyRequestRestriction, (void *)&setting,
            sizeof(uint8_t));
...
const bagl_element_t ui_settings_blue[] = {
    ...
    UI_BLUE_TEXT(0, 30, 105, 160, "Public key export",
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 30, 126, 260, "Enable to approve export requests manually",
                 BAGL_FONT_OPEN_SANS_REGULAR_8_11PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_GRAY, COLOR_BG_1),
    UI_BLUE_TOUCHZONE(0, 78, 320, 68,
                      ui_settings_blue_toggle_pubKeyRequestRestriction,
...
const ux_menu_entry_t menu_settings_pubKeyRequestRestriction[] = {
    {NULL, menu_settings_pubKeyRequestRestriction_change, 1, NULL,
     "Manual approval", NULL, 0, 0},
    {NULL, menu_settings_pubKeyRequestRestriction_change, 0, NULL,
     "Auto approval", NULL, 0, 0},
    UX_MENU_END};
const ux_menu_entry_t menu_settings[] = {
    {menu_settings_pubKeyRequestRestriction, NULL, 0, NULL, "Public keys",
     "export approval", 0, 0},
...
const bagl_element_t ui_details_blue[] = {
    ...
    UI_BLUE_TEXT(0, 30, 106, 320, "VALUE", BAGL_FONT_OPEN_SANS_SEMIBOLD_8_11PX,
                 BAGL_FONT_ALIGNMENT_LEFT, COLOR_GRAY, COLOR_BG_1),
    UI_BLUE_TEXT(0x10, 30, 136, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x11, 30, 159, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x12, 30, 182, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x13, 30, 205, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x14, 30, 228, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x15, 30, 251, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x16, 30, 274, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x17, 30, 297, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x18, 30, 320, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_BLACK, COLOR_BG_1),
    //"..." at the end if too much
    UI_BLUE_TEXT(0x19, 30, 343, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, BAGL_FONT_ALIGNMENT_LEFT,
                 COLOR_GRAY, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 450, 320, "Review the whole value before continuing.",
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_8_11PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_GRAY, COLOR_BG_1)};
...
const bagl_element_t ui_transaction_blue[] = {
    ...
    UI_BLUE_TEXT(0x50, 100, 117, 320, NULL, BAGL_FONT_OPEN_SANS_REGULAR_10_13PX,
                 0, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 100, 138, 320, "Check and confirm values",
                 BAGL_FONT_OPEN_SANS_REGULAR_8_11PX, 0, COLOR_GRAY, COLOR_BG_1),

    // First detail zone
    UI_BLUE_TEXT(0x70, 30, 196, 100, NULL, BAGL_FONT_OPEN_SANS_SEMIBOLD_8_11PX,
                 0, COLOR_BLACK, COLOR_BG_1),
    // x-18 when ...
    UI_BLUE_TEXT(0x10, 130, 200, 160, NULL, BAGL_FONT_OPEN_SANS_REGULAR_10_13PX,
                 BAGL_FONT_ALIGNMENT_RIGHT, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x20, 284, 196, 6, BAGL_FONT_SYMBOLS_0_MINIRIGHT,
                 BAGL_FONT_SYMBOLS_0, BAGL_FONT_ALIGNMENT_RIGHT, COLOR_GRAY,
                 COLOR_BG_1),
    UI_BLUE_TOUCHZONE(0, 168, 320, 48, ui_transaction_blue_1_details,
                      ui_menu_item_out_over, ui_menu_item_out_over),
    ...
    {{BAGL_RECTANGLE, 0x31, 30, 216, 260, 1, 1, 0, 0, COLOR_LIGHT_GRAY,
      COLOR_BG_1, 0, 0},
     NULL,
     0,
     0,
     ...
     NULL,
     NULL},
    UI_BLUE_TEXT(0x71, 30, 245, 100, NULL, BAGL_FONT_OPEN_SANS_SEMIBOLD_8_11PX,
                 0, COLOR_BLACK, COLOR_BG_1),
    // x-18 when ...
    UI_BLUE_TEXT(0x11, 130, 245, 160, NULL, BAGL_FONT_OPEN_SANS_REGULAR_10_13PX,
                 BAGL_FONT_ALIGNMENT_RIGHT, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x21, 284, 245, 6, BAGL_FONT_SYMBOLS_0_MINIRIGHT,
                 BAGL_FONT_SYMBOLS_0, BAGL_FONT_ALIGNMENT_RIGHT, COLOR_GRAY,
                 COLOR_BG_1),
    UI_BLUE_TOUCHZONE(0, 217, 320, 48, ui_transaction_blue_2_details,
                      ui_menu_item_out_over, ui_menu_item_out_over),
    ...
    // separator when second details is to be displayed
    {{BAGL_RECTANGLE, 0x32, 30, 265, 260, 1, 1, 0, 0, COLOR_LIGHT_GRAY,
      COLOR_BG_1, 0, 0},
     NULL,
     0,
     0,
     ...
     NULL,
     NULL},
    UI_BLUE_TEXT(0x72, 30, 294, 100, NULL, BAGL_FONT_OPEN_SANS_SEMIBOLD_8_11PX,
                 0, COLOR_BLACK, COLOR_BG_1),
    // x-18 when ...
    UI_BLUE_TEXT(0x12, 130, 294, 160, NULL, BAGL_FONT_OPEN_SANS_REGULAR_10_13PX,
                 BAGL_FONT_ALIGNMENT_RIGHT, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x22, 284, 294, 6, BAGL_FONT_SYMBOLS_0_MINIRIGHT,
                 BAGL_FONT_SYMBOLS_0, BAGL_FONT_ALIGNMENT_RIGHT, COLOR_GRAY,
                 COLOR_BG_1),
    UI_BLUE_TOUCHZONE(0, 266, 320, 48, ui_transaction_blue_3_details,
                      ui_menu_item_out_over, ui_menu_item_out_over),
    {{BAGL_RECTANGLE, 0x22, 0, 266, 5, 48, 0, 0, BAGL_FILL, COLOR_BG_1,
      COLOR_BG_1, 0,
      0}, // WHY OVER ACTIVATE WHEN TOUCHING OUT OF RECTANGLE ? ASK OTO
     NULL,
     0,
     0x41CCB4,
     0,
    ...
    UI_BLUE_BUTTONS_REJECT_OR_CONFIRM("REJECT", "CONFIRM",
...
ui_transaction_blue_prepro(const bagl_element_t *element) {
  ...
  if ((element->component.type & (~BAGL_FLAG_TOUCHABLE)) == BAGL_NONE) {
    ...
    case 0x60:
      tmp_element.text =
          ui_transaction_blue_details_name[G_ui_transaction_blue_state][3];
      return &tmp_element;
      break;
    ...
    case 0x50:
      tmp_element.text =
          ui_transaction_blue_details_name[G_ui_transaction_blue_state][4];
      return &tmp_element;
      break;
...
const bagl_element_t ui_display_derivation_warning[] = {
    ...
    UI_BLUE_TEXT(0, 0, 185, 320, "The derivation path is unusual.",
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 203, 320, "Reject if you're not sure.",
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 220, 320, "Contact Ledger support for help.",
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 271, 320,
                 "Derivation path:", BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 297, 320, vars.tmp_warning.derivation_path,
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 314, 320, vars.tmp_warning.derivation_path + 30,
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 331, 320, vars.tmp_warning.derivation_path + 60,
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 348, 320, vars.tmp_warning.derivation_path + 90,
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),

    UI_BLUE_BUTTONS_REJECT_OR_CONFIRM(
        "REJECT", "CONFIRM", io_seproxyhal_touch_display_cancel,
        io_seproxyhal_touch_display_address_blue)};

const bagl_element_t ui_display_address_blue[] = {
    UI_BLUE_BACKGROUND("CONFIRM ACCOUNT"),
    UI_BLUE_TEXT(0, 30, 106, 320, "ACCOUNT",
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_8_11PX, 0, COLOR_GRAY,
                 COLOR_BG_1),

    UI_BLUE_TEXT(0x10, 30, 126, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, 0, COLOR_BLACK,
                 COLOR_BG_1),
    UI_BLUE_TEXT(0x11, 30, 139, 260, vars.tmp.addressSummary,
                 BAGL_FONT_OPEN_SANS_REGULAR_10_13PX, 0, COLOR_BLACK,
                 COLOR_BG_1),
...
const bagl_element_t ui_display_token_blue[] = {
    ...
    UI_BLUE_TEXT(0, 30, 185, 260, "Check if the following token is",
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 30, 201, 260, "identical on both devices:",
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0x10, 30, 240, 260, G_io_apdu_buffer + 200,
                 BAGL_FONT_OPEN_SANS_LIGHT_16_22PX, BAGL_FONT_ALIGNMENT_CENTER,
                 COLOR_BLACK, COLOR_BG_1),
...
const bagl_element_t ui_request_pubkey_approval_blue[] = {
    ...
    UI_BLUE_TEXT(0, 0, 160, 320, "Approve to export your public keys",
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
...
const bagl_element_t ui_request_change_path_approval_blue[] = {
    ...
    UI_BLUE_ICON(0x40, 135, 95, 50, 50, &C_blue_badge_warning, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 185, 320, "The change path is unusual.",
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 203, 320, "Reject if you're not sure.",
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
    ...
    UI_BLUE_TEXT(0, 0, 220, 320, "Contact Ledger support for help.",
                 ...
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 271, 320,
                 "Change path:", BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
    UI_BLUE_TEXT(0, 0, 297, 320, vars.tmp_warning.derivation_path,
                 BAGL_FONT_OPEN_SANS_SEMIBOLD_11_16PX,
                 BAGL_FONT_ALIGNMENT_CENTER, COLOR_BLACK, COLOR_BG_1),
...
#define PIXEL_SIZE 5
      ...
      y_off = 139 + (414 - 139) / 2 - vars.tmpqr.qrcode[0] * PIXEL_SIZE / 2;
      bit = 0;

      y = 0;
      x = 0;
      tmp_element.component.fgcolor =
          vars.tmpqr.qrcode[1 + (bit >> 3)] & (1 << (bit & 0x7)) ? COLOR_BLACK
                                                                 : COLOR_WHITE;
...
unsigned int
ui_request_pubkey_approval_blue_prepro(const bagl_element_t *element) {
  copy_element_and_map_coin_colors(element);
  return element;
}

unsigned int
ui_request_change_path_approval_blue_prepro(const bagl_element_t *element) {
  copy_element_and_map_coin_colors(element);
  return element;
}

unsigned int
ui_display_derivation_warning_button(unsigned int button_mask,
                                     unsigned int button_mask_counter) {
  return 0;
}
...
unsigned int
ui_request_pubkey_approval_blue_button(unsigned int button_mask,
                                       unsigned int button_mask_counter) {
  return 0;
}

unsigned int
ui_request_change_path_approval_blue_button(unsigned int button_mask,
                                            unsigned int button_mask_counter) {
  return 0;
}
...
const bagl_element_t ui_display_address_nanos[] = {
    ...
    UI_NANOS_TEXT(2, 0, 12, 128, "The derivation",
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),
    UI_NANOS_TEXT(2, 0, 26, 128, "path is unusual",
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),

    UI_NANOS_TEXT(3, 0, 12, 128, "Derivation path",
                  BAGL_FONT_OPEN_SANS_REGULAR_11px),
    UI_NANOS_SCROLLING_TEXT(0x83, 15, 26, 98, vars.tmp_warning.derivation_path,
                            BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),

    UI_NANOS_ICON_LEFT(4, BAGL_GLYPH_ICON_CROSS),
    UI_NANOS_ICON_RIGHT(4, BAGL_GLYPH_ICON_CHECK),
    UI_NANOS_TEXT(4, 0, 12, 128, "Reject if you're",
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),
    UI_NANOS_TEXT(4, 0, 26, 128, "not sure",
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),
    ...
    // Hex, avoid wasting space
    UI_NANOS_SCROLLING_TEXT(0x86, 15, 26, 98, G_io_apdu_buffer + 199,
                            BAGL_FONT_OPEN_SANS_EXTRABOLD_11px)};

const bagl_element_t ui_display_token_nanos[] = {

    UI_NANOS_BACKGROUND(), UI_NANOS_ICON_LEFT(0, BAGL_GLYPH_ICON_CROSS),
    UI_NANOS_ICON_RIGHT(0, BAGL_GLYPH_ICON_CHECK),
    UI_NANOS_TEXT(1, 0, 12, 128, "Confirm token",
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),
    // Hex, avoid wasting space
    UI_NANOS_TEXT(1, 0, 26, 128, G_io_apdu_buffer + 200,
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px)};
const bagl_element_t ui_request_pubkey_approval_nanos[] = {
    ...
    // Hex, avoid wasting space
    UI_NANOS_TEXT(1, 0, 26, 128, "public key?",
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px)};
...
const bagl_element_t ui_request_change_path_approval_nanos[] = {
    ...
    UI_NANOS_TEXT(2, 0, 12, 128, "The change path",
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),
    UI_NANOS_TEXT(2, 0, 26, 128, "is unusual",
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),

    UI_NANOS_TEXT(3, 0, 12, 128, "Change path",
                  BAGL_FONT_OPEN_SANS_REGULAR_11px),
    UI_NANOS_SCROLLING_TEXT(0x83, 15, 26, 98, vars.tmp_warning.derivation_path,
                            BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),
  ...
  if (element->component.userid > 0) {
    ...
    if (display) {
      ...
      case 0x86:
        ...
        ux_loop_over_curr_element = 1; // when the timer will trigger, ux_step
                                       // won't be incremented, only redraw
        break;
      }
    }
    return display;
...
unsigned int
ui_request_change_path_approval_nanos_prepro(const bagl_element_t *element) {
  if (element->component.userid > 0) {
    unsigned int display = (ux_step == (0x7F & element->component.userid) - 1);
    if (display) {
...
unsigned int ui_display_token_nanos_button(unsigned int button_mask,
                                           unsigned int button_mask_counter);
unsigned int
ui_request_pubkey_approval_nanos_button(unsigned int button_mask,
                                        unsigned int button_mask_counter);
unsigned int
ui_request_change_path_approval_nanos_button(unsigned int button_mask,
                                             unsigned int button_mask_counter);
...
const bagl_element_t ui_verify_nanos[] = {
    ...
    UI_NANOS_TEXT(1, 0, 26, 128, "transaction",
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),

    UI_NANOS_TEXT(2, 0, 12, 128, "Amount", BAGL_FONT_OPEN_SANS_REGULAR_11px),
    UI_NANOS_SCROLLING_TEXT(2, 23, 26, 82, vars.tmp.fullAmount,
                            BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),

    UI_NANOS_TEXT(3, 0, 12, 128, "Address", BAGL_FONT_OPEN_SANS_REGULAR_11px),
    UI_NANOS_SCROLLING_TEXT(3, 23, 26, 82, vars.tmp.fullAddress,
                            BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),

    UI_NANOS_TEXT(4, 0, 12, 128, "Fees", BAGL_FONT_OPEN_SANS_REGULAR_11px),
    UI_NANOS_SCROLLING_TEXT(4, 23, 26, 82, vars.tmp.feesAmount,
                            BAGL_FONT_OPEN_SANS_EXTRABOLD_11px)
...
const bagl_element_t ui_verify_output_nanos[] = {
    ...
    UI_NANOS_ICON_RIGHT(0, BAGL_GLYPH_ICON_CHECK),
    UI_NANOS_TEXT(1, 0, 12, 128, "Confirm", BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),
    UI_NANOS_TEXT(1, 0, 26, 128, vars.tmp.feesAmount,
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),
...
const bagl_element_t ui_finalize_nanos[] = {
    ...
    UI_NANOS_SCROLLING_TEXT(2, 23, 26, 82, vars.tmp.feesAmount,
                            BAGL_FONT_OPEN_SANS_EXTRABOLD_11px)
...
const bagl_element_t ui_verify_message_signature_nanos[] = {
    ...
    UI_NANOS_ICON_LEFT(0, BAGL_GLYPH_ICON_CROSS),
    UI_NANOS_ICON_RIGHT(0, BAGL_GLYPH_ICON_CHECK),
    UI_NANOS_TEXT(1, 0, 12, 128, "Sign the",
                  BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),
    UI_NANOS_TEXT(1, 0, 26, 128, "message", BAGL_FONT_OPEN_SANS_EXTRABOLD_11px),

    UI_NANOS_TEXT(2, 0, 12, 128, "Message hash",
                  BAGL_FONT_OPEN_SANS_REGULAR_11px),
    UI_NANOS_SCROLLING_TEXT(2, 23, 26, 82, vars.tmp.fullAddress,
                            BAGL_FONT_OPEN_SANS_EXTRABOLD_11px)};
unsigned int
...
unsigned int ui_display_address_nanos_button(unsigned int button_mask,
  ...
  if (ux_step == 3) {
    ...
    if (button_mask == (BUTTON_EVT_RELEASED | BUTTON_LEFT | BUTTON_RIGHT)) {
      // if we were looping over a single element, disable this loop and diffuse
      // the redisplay timeout (used by scrolling text)
...
void ui_message_signature_blue_init(void) {
  ui_transaction_blue_ok =
      (bagl_element_callback_t)io_seproxyhal_touch_message_signature_verify_ok;
...
UX_STEP_VALID(ux_idle_flow_2_step, pb,
...
UX_STEP_VALID(ux_sign_flow_3_step, pbb,
              io_seproxyhal_touch_message_signature_verify_ok(NULL),
              {
                  &C_icon_validate_14,
                  "Sign",
...
UX_STEP_VALID(ux_sign_flow_4_step, pbb,
              io_seproxyhal_touch_message_signature_verify_cancel(NULL),
              {
                  &C_icon_crossmark,
                  "Cancel",
...
UX_STEP_VALID(ux_confirm_full_flow_5_step, pbb,
              io_seproxyhal_touch_verify_ok(NULL),
              {
                  &C_icon_validate_14,
                  "Accept",
...
UX_STEP_VALID(ux_confirm_full_flow_6_step, pb,
              io_seproxyhal_touch_verify_cancel(NULL),
              {
                  &C_icon_crossmark,
                  "Reject",
...
UX_STEP_NOCB(ux_confirm_single_flow_4_step, bnnn_paging,
             {
                 .title = "Fees",
                 .text = vars.tmp.feesAmount,
             });
UX_STEP_VALID(ux_confirm_single_flow_5_step, pb,
              io_seproxyhal_touch_verify_ok(NULL),
              {
                  &C_icon_validate_14,
                  "Accept",
              });
UX_STEP_VALID(ux_confirm_single_flow_6_step, pb,
              io_seproxyhal_touch_verify_cancel(NULL),
              {
                  &C_icon_crossmark,
                  "Reject",
...
UX_FLOW(ux_confirm_single_flow, &ux_confirm_single_flow_1_step,
        ...
        &ux_confirm_single_flow_4_step, &ux_confirm_single_flow_5_step,
...
UX_STEP_VALID(ux_finalize_flow_5_step, pbb, io_seproxyhal_touch_verify_ok(NULL),
              {&C_icon_validate_14, "Accept", "and send"});
UX_STEP_VALID(ux_finalize_flow_6_step, pb,
              io_seproxyhal_touch_verify_cancel(NULL),
              {
                  &C_icon_crossmark,
                  "Reject",
...
UX_STEP_VALID(ux_display_public_flow_3_step, pnn,
              io_seproxyhal_touch_display_cancel(NULL),
              {
                  &C_icon_crossmark,
                  "Reject if you're",
...
UX_STEP_VALID(ux_display_public_flow_7_step, pb,
              io_seproxyhal_touch_display_cancel(NULL),
              {
                  &C_icon_crossmark,
                  "Reject",
...
//////////////////////////////////////////////////////////////////////
UX_STEP_VALID(ux_display_token_flow_1_step, pbb,
              io_seproxyhal_touch_display_ok(NULL),
              {
                  &C_icon_validate_14,
                  "Confirm token",
...
UX_STEP_VALID(ux_display_token_flow_2_step, pb,
              io_seproxyhal_touch_display_cancel(NULL),
              {
                  &C_icon_crossmark,
                  "Reject",
...
//////////////////////////////////////////////////////////////////////
UX_STEP_VALID(ux_request_pubkey_approval_flow_1_step, pbb,
              io_seproxyhal_touch_display_ok(NULL),
              {
                  &C_icon_validate_14,
                  "Export",
...
UX_STEP_VALID(ux_request_pubkey_approval_flow_2_step, pb,
              io_seproxyhal_touch_display_cancel(NULL),
              {
                  &C_icon_crossmark,
                  "Reject",
...
UX_STEP_VALID(ux_request_change_path_approval_flow_3_step, pbb,
              io_seproxyhal_touch_display_cancel(NULL),
              {
                  &C_icon_crossmark,
                  "Reject if you're",
...
UX_STEP_VALID(ux_request_change_path_approval_flow_4_step, pb,
              io_seproxyhal_touch_display_ok(NULL),
              {
                  &C_icon_validate_14,
                  "Approve",
...
uint8_t prepare_single_output() {
  ...
  if (btchip_output_script_is_op_return(btchip_context_D.currentOutput +
    ...
    strcpy(vars.tmp.fullAddress, "OP_RETURN");
             ...
             btchip_output_script_is_op_create(btchip_context_D.currentOutput +
                                               offset)) {
  ...
  if (vars.tmp.fullAddress[0] == 0) {
    if (!nativeSegwit) {
      ...
      if (btchip_context_D.usingCashAddr) {
        cashaddr_encode(address + versionSize, 20, tmp, sizeof(tmp),
                        (version == btchip_context_D.payToScriptHashVersion
                             ? CASHADDR_P2SH
                             : CASHADDR_P2PKH));
      } else {
      ...
      textSize =
          segwit_addr_encode(tmp, PIC(G_coin_config->native_segwit_prefix), 0,
  ...
  if ((btchip_context_D.currentOutput[offset + 2] == 0x14) &&
      (os_memcmp(btchip_context_D.currentOutput + offset + 3, "omni", 4) ==
       0) &&
      (os_memcmp(btchip_context_D.currentOutput + offset + 3 + 4, "\0\0\0\0",
                 4) == 0)) {
    uint8_t headerLength;
    uint32_t omniAssetId = btchip_read_u32(
        btchip_context_D.currentOutput + offset + 3 + 4 + 4, 1, 0);
    switch (omniAssetId) {
    case OMNI_ASSETID:
    ...
    textSize = btchip_convert_hex_amount_to_displayable(
        btchip_context_D.currentOutput + offset + 3 + 4 + 4 + 4);
...
uint8_t prepare_full_output(uint8_t checkOnly) {
  ...
  for (i = 0; i < numberOutputs; i++) {
    ...
    isOpReturn = btchip_output_script_is_op_return(
        btchip_context_D.currentOutput + offset);
    isP2sh =
        btchip_output_script_is_p2sh(btchip_context_D.currentOutput + offset);
    isNativeSegwit = btchip_output_script_is_native_witness(
        btchip_context_D.currentOutput + offset);
    isOpCreate = btchip_output_script_is_op_create(
        btchip_context_D.currentOutput + offset);
    isOpCall = btchip_output_script_is_op_call(btchip_context_D.currentOutput +
                                               offset);
  ...
  if (!checkOnly) {
    ...
    for (i = 0; i < numberOutputs; i++) {
      if (((G_coin_config->kind == COIN_KIND_QTUM) &&
           !btchip_output_script_is_op_return(btchip_context_D.currentOutput +
                                              offset + 8) &&
           !btchip_output_script_is_op_create(btchip_context_D.currentOutput +
                                              offset + 8) &&
           !btchip_output_script_is_op_call(btchip_context_D.currentOutput +
          ...
          if (!isNativeSegwit) {
            ...
            textSize = segwit_addr_encode(
                ...
                btchip_context_D.currentOutput
                    [offset + OUTPUT_SCRIPT_NATIVE_WITNESS_PROGRAM_OFFSET - 1]);
          }
...
uint8_t prepare_message_signature() {
  ...
  snprintf(vars.tmp.fullAddress, sizeof(vars.tmp.fullAddress), "%.*H...%.*H", 8,
           buffer, 8, buffer + 32 - 8);
  return 1;
}
...
void btchip_bagl_display_public_key(unsigned char *derivation_path) {
  ...
  bip32_print_path(derivation_path, vars.tmp_warning.derivation_path,
                   MAX_DERIV_PATH_ASCII_LENGTH);
  uint8_t is_derivation_path_unusual =
      bip44_derivation_guard(derivation_path, false);

#if defined(TARGET_BLUE)

  if (is_derivation_path_unusual) {
    UX_DISPLAY(ui_display_derivation_warning,
               ui_request_change_path_approval_blue_prepro);
  } else {
    load_qr_code(G_io_apdu_buffer + 200);
    UX_DISPLAY(ui_display_address_blue, ui_display_address_blue_prepro);
  }
...
#if defined(TARGET_BLUE)
  UX_DISPLAY(ui_request_pubkey_approval_blue,
             ui_request_pubkey_approval_blue_prepro);
#elif defined(TARGET_NANOS)
...
void btchip_bagl_request_change_path_approval(unsigned char *change_path) {
  bip32_print_path(change_path, vars.tmp_warning.derivation_path,
                   MAX_DERIV_PATH_ASCII_LENGTH);
#if defined(TARGET_BLUE)
  UX_DISPLAY(ui_request_change_path_approval_blue,
             ui_request_change_path_approval_blue_prepro);
#elif defined(TARGET_NANOS)
  // append and prepend a white space to the address
  ux_step = 0;
  ux_step_count = 4;
  UX_DISPLAY(ui_request_change_path_approval_nanos,
             ui_request_change_path_approval_nanos_prepro);
#elif defined(TARGET_NANOX) || defined(TARGET_NANOS2)
